...
class Ui_AddEntityDialog(object):
    def setupUi(self, AddEntityDialog):
        ...
        AddEntityDialog.resize(448, 238)
        AddEntityDialog.setMinimumSize(QtCore.QSize(448, 238))
        AddEntityDialog.setMaximumSize(QtCore.QSize(448, 238))
        ...
        self.combo_box_choose_entity.setGeometry(QtCore.QRect(100, 20, 331, 21))
        ...
        self.line_edit_set_id.setGeometry(QtCore.QRect(100, 50, 331, 21))
        self.line_edit_set_id.setObjectName("line_edit_set_id")
        self.line_edit_brick_type = QtWidgets.QLineEdit(AddEntityDialog)
        self.line_edit_brick_type.setGeometry(QtCore.QRect(100, 80, 331, 21))
        ...
        self.plain_text_edit_brick_definition.setGeometry(QtCore.QRect(100, 110, 331, 81))
        ...
        self.button_add_entity.setGeometry(QtCore.QRect(270, 200, 75, 23))
        self.button_add_entity.setObjectName("button_add_entity")
        self.button_cancel = QtWidgets.QPushButton(AddEntityDialog)
        self.button_cancel.setGeometry(QtCore.QRect(355, 200, 75, 23))
