...
class Ui_AddEntityDialog(object):
    def setupUi(self, AddEntityDialog):
        ...
        AddEntityDialog.resize(478, 262)
        AddEntityDialog.setMinimumSize(QtCore.QSize(478, 262))
        AddEntityDialog.setMaximumSize(QtCore.QSize(478, 262))
        ...
        self.combo_box_choose_entity.setGeometry(QtCore.QRect(100, 40, 361, 21))
        ...
        self.line_edit_set_id.setGeometry(QtCore.QRect(100, 70, 361, 21))
        self.line_edit_set_id.setObjectName("line_edit_set_id")
        self.line_edit_brick_type = QtWidgets.QLineEdit(AddEntityDialog)
        self.line_edit_brick_type.setGeometry(QtCore.QRect(100, 100, 361, 21))
        ...
        self.plain_text_edit_brick_definition.setGeometry(QtCore.QRect(100, 130, 361, 81))
        ...
        self.button_add_entity.setGeometry(QtCore.QRect(305, 220, 75, 23))
        self.button_add_entity.setObjectName("button_add_entity")
        self.button_cancel = QtWidgets.QPushButton(AddEntityDialog)
        self.button_cancel.setGeometry(QtCore.QRect(385, 220, 75, 23))
        self.button_cancel.setObjectName("button_cancel")
        self.combo_box_choose_group = QtWidgets.QComboBox(AddEntityDialog)
        self.combo_box_choose_group.setGeometry(QtCore.QRect(100, 10, 361, 21))
