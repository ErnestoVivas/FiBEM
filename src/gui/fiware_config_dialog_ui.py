...
class Ui_FiwareConfigDialog(object):
    def setupUi(self, FiwareConfigDialog):
        ...
        FiwareConfigDialog.resize(485, 301)
        FiwareConfigDialog.setMinimumSize(QtCore.QSize(485, 301))
        FiwareConfigDialog.setMaximumSize(QtCore.QSize(485, 301))
        ...
        self.line_edit_url.setGeometry(QtCore.QRect(140, 40, 331, 21))
        self.line_edit_url.setObjectName("line_edit_url")
        self.line_edit_api_key = QtWidgets.QLineEdit(FiwareConfigDialog)
        self.line_edit_api_key.setGeometry(QtCore.QRect(140, 130, 251, 21))
        ...
        self.line_edit_fiware_service.setGeometry(QtCore.QRect(140, 70, 331, 21))
        ...
        self.line_edit_fiware_service_path.setGeometry(QtCore.QRect(140, 100, 331, 21))
        ...
        self.combo_box_time_zone.setGeometry(QtCore.QRect(140, 160, 251, 21))
        ...
        self.line_edit_mqtt_topics_file.setGeometry(QtCore.QRect(140, 190, 251, 21))
        ...
        self.button_open_mqtt_topics_file.setGeometry(QtCore.QRect(400, 190, 71, 21))
        ...
        self.line_edit_grafana_config_file.setGeometry(QtCore.QRect(140, 220, 251, 21))
        ...
        self.button_open_grafana_config_file.setGeometry(QtCore.QRect(400, 220, 71, 21))
        ...
        self.button_random_api_key.setGeometry(QtCore.QRect(400, 130, 71, 21))
