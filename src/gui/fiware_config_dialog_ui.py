...
class Ui_FiwareConfigDialog(object):
    def setupUi(self, FiwareConfigDialog):
        ...
        FiwareConfigDialog.resize(475, 302)
        FiwareConfigDialog.setMinimumSize(QtCore.QSize(0, 0))
        FiwareConfigDialog.setMaximumSize(QtCore.QSize(16777215, 16777215))
        ...
        self.line_edit_url.setGeometry(QtCore.QRect(130, 40, 331, 21))
        self.line_edit_url.setObjectName("line_edit_url")
        self.line_edit_api_key = QtWidgets.QLineEdit(FiwareConfigDialog)
        self.line_edit_api_key.setGeometry(QtCore.QRect(130, 130, 251, 21))
        ...
        self.line_edit_fiware_service.setGeometry(QtCore.QRect(130, 70, 331, 21))
        ...
        self.line_edit_fiware_service_path.setGeometry(QtCore.QRect(130, 100, 331, 21))
        ...
        self.combo_box_time_zone.setGeometry(QtCore.QRect(130, 160, 251, 21))
        ...
        self.line_edit_mqtt_topics_file.setGeometry(QtCore.QRect(130, 190, 251, 21))
        ...
        self.button_open_mqtt_topics_file.setGeometry(QtCore.QRect(390, 190, 71, 21))
        ...
        self.line_edit_grafana_config_file.setGeometry(QtCore.QRect(130, 220, 251, 21))
        ...
        self.button_open_grafana_config_file.setGeometry(QtCore.QRect(390, 220, 71, 21))
        ...
        self.button_random_api_key.setGeometry(QtCore.QRect(390, 130, 71, 21))
