...
class Ui_ShowDevicesDialog(object):
    def setupUi(self, ShowDevicesDialog):
        ...
        ShowDevicesDialog.resize(495, 458)
        ShowDevicesDialog.setMinimumSize(QtCore.QSize(495, 458))
        ShowDevicesDialog.setMaximumSize(QtCore.QSize(495, 458))
        ...
        self.combo_box_entities.setGeometry(QtCore.QRect(80, 10, 401, 22))
        ...
        self.list_widget_devices.setGeometry(QtCore.QRect(80, 40, 401, 151))
        ...
        self.text_edit_device_properties.setGeometry(QtCore.QRect(80, 230, 401, 171))
