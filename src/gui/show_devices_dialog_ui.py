...
class Ui_ShowDevicesDialog(object):
    def setupUi(self, ShowDevicesDialog):
        ...
        ShowDevicesDialog.resize(545, 498)
        ShowDevicesDialog.setMinimumSize(QtCore.QSize(545, 498))
        ShowDevicesDialog.setMaximumSize(QtCore.QSize(545, 498))
        ...
        self.combo_box_entities.setGeometry(QtCore.QRect(100, 10, 431, 22))
        ...
        self.list_widget_devices.setGeometry(QtCore.QRect(100, 40, 431, 151))
        ...
        self.text_edit_device_properties.setGeometry(QtCore.QRect(100, 200, 431, 241))
        font = QtGui.QFont()
        ...
        self.button_ok.setGeometry(QtCore.QRect(455, 460, 75, 23))
